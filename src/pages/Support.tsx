      ...
      <div className="mx-4 my-4 rounded-[2rem] overflow-hidden hero-gradient">
        ...
        <main className="max-w-5xl mx-auto px-6 md:px-12 pb-16 md:pb-24">
          <div className="bg-card/95 backdrop-blur rounded-[2rem] border border-border/40 shadow-card p-6 md:p-10 lg:p-12">
            <p className="text-xs uppercase tracking-[0.28em] text-muted-foreground">Help</p>
            <h1 className="font-display text-3xl md:text-5xl font-bold tracking-tight mt-3">Support</h1>
            <p className="mt-4 text-base leading-7 text-foreground/80">
              Having trouble with Shoflak Klba or have a question? We're here to help. Reach out to us and we'll get back to you as soon as possible.
            </p>

            {/* Contact */}
            <div className="mt-10 space-y-4">
              <h2 className="font-display text-2xl md:text-3xl font-semibold tracking-tight">Contact Us</h2>
            ...
            <div className="mt-10 space-y-4">
              ...
              <p className="text-base leading-7 text-foreground/80">
                You can also reach out or follow us on social media:
              </p>
